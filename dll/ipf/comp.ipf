...
the containers is synched so that scrolling one scrolls both.  The files
...
:p.
The line of :hp1.Actions&colon.:ehp1. pushbuttons allow you to
...
:p.
If you're looking for more powerful directory matching software, you
might be interested in Larry Waibel's :hp1.PMDirMatch:ehp1. shareware
program.  Larry can be contacted on Compuserve at user ID 71333,2463,
and he hangs out in the OS2SHARE (library 1 of OS2BVEN) forum. You can
easily set FM/2 up to use PMDirMatch automatically using the :link
reftype=hd res=98400.Compare page:elink. of the internal Settings
notebook.
