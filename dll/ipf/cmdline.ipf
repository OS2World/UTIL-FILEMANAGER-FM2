...
named CMDLINES.DAT between sessions.  Pressing the :hp1.Delete:ehp1. key
(or clicking the :hp1.Del:ehp1. button that appears) while one of the
names in the listbox is highlighted will remove it. Pressing :hp1.Ctrl +
Delete:ehp1. will remove (wipe) all entries.
:p.
