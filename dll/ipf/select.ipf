...
:p.
:hp1.Deselect All:ehp1. has an accelerator &CtrlKey. + :color fc=default bc=palegray.\:color fc=default bc=default..
:p.
:hp1.Select All Files:ehp1. Selects all the file objects in a
container. The accelerator key &CtrlKey. + :color fc=default bc=palegray./:color fc=default bc=default. is assigned to this command.
:p.
:hp1.Select All Dirs:ehp1. Selects all the directory objects in a
container. The accelerator key &ShiftKey. + &CtrlKey. + :color fc=default bc=palegray.?:color fc=default bc=default. is assigned to this
command
:p.
:hp1.Deselect All Dirs:ehp1. has an accelerator &ShiftKey. + &CtrlKey. + :color fc=default bc=palegray.|:color fc=default bc=default.
:p.
...
container, you could select one of the files, then type &CtrlKey. + :color fc=default bc=palegray.=:color fc=default bc=default. (the
...
this command. The accelerator for this command is &CtrlKey. + :color fc=default bc=palegray.]:color fc=default bc=default..
:p.
The accelerator for the Deselect clipboard command is &ShiftKey. + &CtrlKey. + :color fc=default bc=palegray.}:color fc=default bc=default..
:p.
...
last selected items. The accelerator is &CtrlKey. + :color fc=default bc=palegray.'t:color fc=default bc=default..
:p.
:hp1.Invert selection:ehp1. Selects what isn't, deselects what is. In
other words, reverses the current selection set.
The accelerator is &CtrlKey. + :color fc=default bc=palegray.;:color fc=default bc=default..
:p.
