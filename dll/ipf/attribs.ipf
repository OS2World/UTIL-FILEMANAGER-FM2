...
:p.
This dialog allows you to set the attributes and/or date and
...
attribute (checked box), or ignore attribute (grayed box, "indeterminate
...
grayed results in a "touch" of the file system objects selected for the
...
attrs:ehp1. button to gray all the attribute checkboxes at once. If
all attribute checkboxes are already grayed, clicking this button causes
