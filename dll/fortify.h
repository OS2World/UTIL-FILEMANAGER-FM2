...
#ifdef __BORLANDC__
#ifdef __OS2__
    /* Borland C++ 2.0 OS/2 configuration */
    #define FORTIFY_PROVIDE_ARRAY_NEW
    #define FORTIFY_PROVIDE_ARRAY_DELETE
    #define FORTIFY_FAIL_ON_ZERO_MALLOC
    #define FORTIFY_STRDUP		// have non-ANSI strdup()
#endif
#endif
...
#include <new.h>
    ...
    void *operator new(size_t size, const char *file, int line);	// 16 Jan 08 SHL
    void  operator delete(void *pointer);
    void  Fortify_PreDelete(const char *file, int line);	// 16 Jan 08 SHL
