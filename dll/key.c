...
MRESULT EXPENTRY AboutDlgProc (HWND hwnd,ULONG msg,MPARAM mp1,MPARAM mp2)
{
  ...
  static HPOINTER stick1,stick2,stick3,stick4,stick12,stick22,stick32,stick42,
                  stick5,stick52;
    ...
    case WM_TIMER:
      ...
      if(swp.x + (swp.cx * 3) > width - 3) {
        ...
        WinSendDlgItemMsg(hwnd,
                          ...
                          MPFROMLONG(stick3),
                          MPVOID);
        WinShowWindow(WinWindowFromID(hwnd,ABT_STICK1),
                      TRUE);
        WinShowWindow(WinWindowFromID(hwnd,ABT_STICK2),
                      FALSE);
        WinSendDlgItemMsg(hwnd,
                          ABT_STICK2,
                          SM_SETHANDLE,
